...
export function Textarea({
  ...
  return (
    <textarea
      className={cn(
        "bg-bg-2 border-hairline-strong text-text placeholder:text-muted min-h-[130px] w-full resize-y rounded-xs border p-3.5 text-base leading-[1.4] outline-none",
